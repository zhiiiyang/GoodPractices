...
<a href="mailto:zyang895@gmail.com"><i class="fa fa-paper-plane fa-fw"></i>&nbsp; zyang895@gmail.com</a><br>
<a href="http://twitter.com/apreshill"><i class="fa fa-twitter fa-fw"></i>&nbsp; @zhiiiyang</a><br>
<a href="http://github.com/zhiiiyang"><i class="fa fa-github fa-fw"></i>&nbsp; @zhiiiyang</a><br>
...
- haven't used R for three months or worked on more than `5` projects

--

- expect to see a systematic review like a book
...
- from my daily rigmen of programming in R
...
###YES!
```{r}
pathName <- "files/dataset-2019-01.csv"
```
